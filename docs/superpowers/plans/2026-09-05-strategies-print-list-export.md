...
export const noMirror: Strategy = {
  id: 'no-mirror',
  name: 'No mirroring',
  description: 'Prefers symmetric boards so nothing needs mirroring in the slicer; may use an extra board or leave up to one pitch uncovered, and falls back to Balanced when no symmetric layout fits.',
  search: (ctx) =>
    bestPartition(ctx, {
      tol: 1,
      extraK: 2,
